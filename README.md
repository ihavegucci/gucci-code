...
Всё остальное подчинено дешевизне: 5 файлов, 4 этапа, ~55 000 знаков инструкций за прогон,
...
файлы этапов читаются по ходу прогона, шаблон дашборда копируется в проект.
...
Скилл прогнан от начала до конца **дважды, на живых задачах**, с настоящими субагентами и
работающим кодом:
...
2. Режим «допроси» — гонялись только автомат и полуавтомат.
3. Возобновление после сжатия контекста.
4. Глубины «строго» и «глубоко».
5. Живое обновление дашборда раз в 10 секунд.
